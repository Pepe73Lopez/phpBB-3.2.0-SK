...
$lang = array_merge($lang, array(
	...
	'DELETE_POST_PERMANENTLY'			=> 'Príspevok bude natrvalo odstránený a nebude možné ho obnoviť',
	'DELETE_POSTS_CONFIRM'				=> 'Ste si istý, že chcete odstrániť tieto príspevky?',
	...
	'FLOOD_ERROR'		=> 'Nemôžete tak skoro po odoslaní svojho predchádzajúceho príspevku odoslať ďalší.',
	...
	'MESSAGE_BODY_EXPLAIN' => array(
		...
		1 => 'Sem vložte svoju správu, nemôže obsahovať viac než <strong>%d</strong> znak.',
		2 => 'Sem vložte svoju správu, nemôže obsahovať viac než <strong>%d</strong> znaky.',
		3 => 'Sem vložte svoju správu, nemôže obsahovať viac než <strong>%d</strong> znakov.',
	),
	...
	'NO_DELETE_POLL_OPTIONS'		=> 'Nemôžete zmazať možnosti už publikovaného hlasovania.',
	'NO_PM_ICON'				=> 'Žiadna',
	'NO_POLL_TITLE'			=> 'Musíte zadať názov hlasovania.',
	'NO_POST'					=> 'Požadovaný príspevok neexistuje.',
	'NO_POST_MODE'				=> 'Nebol zvolený typ odoslania.',
	'NO_TEMP_DIR'				=> 'Dočasný adresár nenájdený alebo je chránený proti zápisu.',

	'PARTIAL_UPLOAD'			=> 'Súbor bol odovzdaný len čiastočne.',
	'PHP_UPLOAD_STOPPED'		=> 'Rožšírenie PHP zapríčinilo zastavenie odovzdávania súboru.',
	...
	'POLL_MAX_OPTIONS'			=> 'Maximálny počet volieb, ktoré môže užívateľ zvoliť',
	...
	'SMILIES'					=> 'Emotikony',
	'SMILIES_ARE_OFF'			=> 'Emotikony sú <em>ZAKÁZANÉ</em>',
	'SMILIES_ARE_ON'			=> 'Emotikony sú <em>POVOLENÉ</em>',
